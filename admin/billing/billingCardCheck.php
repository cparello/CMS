...
$merchant_reference_code = urldecode($merchant_reference_code);
...
if($achBool != "" &&  $ccBool != "") {
     ...
     $merchField1 = "ACH Past Dues $merchant_reference_code";
    $payTypeFlag = "check";
...
if($achAuthReasonCode != 100) {
    ...
    $reference = "CC Past Dues $merchant_reference_code";
        //credit"";//
    ...
    if($ccAuthReasonCode != 100) {
        $card_result = "There was an error processing this transaction.  This Credit Card will not be charged. ERROR: $ccAuthDecision ";
         ...
         $_SESSION['cc_request_id'] = $transactionId;
         $card_result = 1; 
         echo"$card_result";
         exit;       
       }
...
if($achAuthReasonCode != 100) {
    $ach_result = "There was a problem verifying this Banking information.  Please check the Banking fields and re-enter this information. ERROR2: $achAuthReasonCode";
    echo"$ach_result";
    exit;   
   }else{ 
     $_SESSION['ach_request_id'] = $transactionId;
