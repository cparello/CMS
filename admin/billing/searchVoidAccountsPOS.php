...
$javaScript1 ="<script type=\"text/javascript\" src=\"../scripts/searchVoidPosHistory.js\"></script>";
$javaScript2 ="<script type=\"text/javascript\" src=\"../scripts/helpTxtPos4.js\"></script>";
$javaScript3 ="<script type=\"text/javascript\" src=\"../scripts/helpPops.js\"></script>";


include "../templates/infoTemplate2.php";
include "../templates/searchAccountsTemplateVoidPOS.php";
