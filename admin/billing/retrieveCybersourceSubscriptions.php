...
";
  $stmt999 = $dbMain->prepare("SELECT subscription_id, subscription_type FROM cs_subscriptions WHERE contract_key = '$this->contractKey'");
  $stmt999->execute();      
  $stmt999->store_result();      
  $stmt999->bind_result($subscription_id, $subscription_type); 
...
<h3><center>$this->title Subscription Information $counter</center></h3>
</td>
...
$counter++;
  ...
  $stmt999->close();
    ...
    $subHtml = "<h3><center>No Subscriptions have been created!</center></h3>";
   }
