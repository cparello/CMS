...
$page_title  = 'Edit Bundle Description';
...
$javaScript7 ="<script type=\"text/javascript\" src=\"../scripts/updateBundleDescription.js\"></script>";
...
include "../templates/editBundleDescriptionTemplate.php";
