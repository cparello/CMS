...
$start_range = date('Y-m-d H:i:s',mktime(0,0,0,date('m'),date('d'),date('Y')));
$end_range = date('Y-m-d H:i:s',mktime(23,59,59,date('m'),date('d'),date('Y')));
//get the date
...
$header_admin = "$nick_name Sales Console";
$_SESSION['header_admin'] = $header_admin;

include  "../templates/salesLoginTemplate2.php";
