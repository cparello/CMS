...
if($marker == 1)  {
 ...
 switch($location) {          
      ...
      $email_to = 'hdfitness@charter.net';
      break;
      case"north":
 ...
 mail("$email_to", "PT Assesment Lead $location",
"Name:       $name
...
Your information has been received.
 A trainer will contact you within 24 hours.
 </p>
 <p class="posit">
 <br>
 <center>
 <form>
<input type=button value="Close Window" id="closeLink" >
</form> 
 </center>
