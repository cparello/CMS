...
if($achBool != "" &&  $ccBool != "") {
    ...
    $merchField1 = "ACH Web Member Sales";
    $payTypeFlag = "check";
...
if($ccBool != "" &&  $achBool == "") {
   ...
   //$ccAuthReasonCode = 100;
    ...
    if($ccAuthReasonCode != 100) {
       $card_result = "The Credit Card that was entered has been DECLINED because of $ccAuthDecision Code: $ccAuthReasonCode";
         echo"$card_result";
         exit;
    ...
    /*  }else{
          $_SESSION['cc_request_id'] = "847TEST7723";
           $card_result = 1;
           $transactionBool = 1;
...
$termText = urldecode($termText);
$termText = $_REQUEST['termText'];



include "php/salesSql.php";
...
$salesSql-> setTermText($termText);
//set the initial payment type


//set the monthly billing
$salesSql-> setMonthAmount($dues);
