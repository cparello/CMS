           ...
           $('#masterTotal').html(totalPrice);
            //submit
             $('.b21').click(function() {
                ...
                var serviceDetails = $('input:radio[name=serviceOptions1]:checked').val();var dataArray = serviceDetails.split("|");
...
<body>
<script type="text/javascript" src="js/checkRenewalSalesv2.js"></script>
    <?php 
    include_once('inc/header.php'); 
    $serviceName = $_REQUEST['service_name'];
    $numYears = trim($_REQUEST['service_quantity']);
    $total = $_REQUEST['service_cost'];
    //$numYears = 1;
    ...
    $stmt->execute();      
    $stmt->store_result();      
    $stmt->bind_result($first_nameLi, $middle_nameLi, $last_nameLi, $streetLi, $cityLi, $stateLi, $zipLi, $primary_phoneLi, $cell_phoneLi, $emailLi, $dobLi, $date, $club_id, $host_type);
    $stmt->fetch();
    $stmt->close();
    
    $dobLi = date('m-d-Y',strtotime($dobLi));
    
    //echo "$first_nameLi, $middle_nameLi, $last_nameLi, $streetLi, $cityLi, $stateLi, $zipLi, $primary_phoneLi, $cell_phoneLi, $emailLi, $dobLi, $date, $club_id, $host_type";
    ...
    if($host_type == "L"){
        ...
        $first_nameM = $first_nameLi;
        $middle_nameM = $middle_nameLi;
        $last_nameM = $last_nameLi;
        $streetM = $streetLi;
        $cityM = $cityLi;
        $stateM = $stateLi;
        $zipM = $zipLi;
        $primary_phoneM = $primary_phoneLi;
        $cell_phoneM = $cell_phoneLi;
        $emailM = $emailLi;
        $dobM = $dobLi;
    }
    
     //echo "$first_nameM, $middle_nameM, $last_nameM, $streetM, $cityM, $stateM, $zipM, $primary_phoneM, $cell_phoneM, $emailM, $dobM";
    $purchaseArray = "$serviceKey|$serviceName|$total|$qty|$numYears";
   ...
   switch($rate_eft_cycle) {
        ...
        <table width="100%">
            ...
            <tbody>
                <tr>
                    ...
                    <td><?php echo "$numYears $termText";?></td>
                </tr>
            </tbody>
        </table>
    </div>
    ...
    <div class="row">
       ...
       <div class="row">
        ...
        <input tabindex="125" name="first_name[]" type="text" id="first_name" value="<?php  echo $first_nameM ?>" onclick="return checkServices(this.name,this.id)" placeholder="First Name (REQUIRED)"  required>
        <input tabindex="128" name="street_address[]" type="text" id="street_address" value="<?php  echo $streetM ?>" onclick="return checkServices(this.name,this.id)" placeholder="Street Address(REQUIRED)"  required>
        <input tabindex="131" name="zip_code[]" type="text" id="zip_code" value="<?php  echo $zipM ?>" placeholder="Zip Code(REQUIRED)" onclick="return checkServices(this.name,this.id)" >
        <input tabindex="134"  name="email[]" type="text" id="email" value="<?php  echo $emailM ?>" onclick="return checkServices(this.name,this.id)" placeholder="Email(REQUIRED)"  required>
        </div>
        
        <div class="small-12 large-4 columns">
        <input tabindex="126" tabindex="126" name="middle_name[]" type="text" id="middle_name" value="<?php  echo $middle_nameM ?>" onclick="return checkServices(this.name,this.id)" placeholder="Middle Name (optional)">
        <input tabindex="129" name="city[]" type="text" id="city" value="<?php  echo $cityM ?>"  onclick="return checkServices(this.name,this.id)" placeholder="City(REQUIRED)" required>
        <input  tabindex="132"name="home_phone[]" type="text" id="home_phone" value="<?php  echo $primary_phoneM ?>" onclick="return checkServices(this.name,this.id)" placeholder="Phone(REQUIRED)" required>
        <input tabindex="135"  name="dob[]" type="text" id="dob" value="<?php  echo $dobM ?>" onclick="return checkServices(this.name,this.id)" placeholder="Date of Birth (MM/DD/YYYY)(REQUIRED)" required> 
        </div>
        
        <div class="small-12 large-4 columns">
        <input tabindex="127" name="last_name[]" type="text" id="last_name" value="<?php  echo $last_nameM ?>" onclick="return checkServices(this.name,this.id)" placeholder="Last Name(REQUIRED)" required>
        <select tabindex="130"  name="state[]" id="state" required>
        <option tabindex="133" value="<?php  echo $stateM  ?>" selected=""><?php  echo $stateM  ?></option>
