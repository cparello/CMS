...
//window.open('php/contractWindow.php?ptBool=2','','scrollbars=yes,menubar=no,height=600,width=800,resizable=no,toolbar=no,location=no,status=no');
window.location = "php/contractWindow.php?ptBool=2";
}
...
//setPaymentRadioButtons();
  ...
  $("#submitPt").click(function() {
    ...
    /*if(alreadyMember == 0)  {
     ...
     //  if (alreadyMember == 0){
     //   if(document.getElementById('liability_host').checked == false){
     ...
     //   }
           ...
           // var licNumber = '#lic_num'+i;
            ...
            var cellPhone = $(homePhoneNumber).val();
                ...
                if(billType == "BA") {
                 ...
                 if($('#verifyMaint').html() != "" ){  
                    if($("mFee").val() != 0.00){
                        ...
                        //alert('Please read the \" maintenance Fee Transaction Request:\" and agree to the terms by selecting yes to continue.');
                        //return false;
