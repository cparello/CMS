...
//alert(creditPay);
    ...
    $.ajax ({
                 ...
                 async: false,
                 dataType: 'html', 
                 data: {credit_payment: creditPay, card_type: cardType, card_number: cardNumber, card_name: cardName, card_cvv: cardCvv, card_month: cardMonth, card_year: cardYear, memberId: memberId, newNonMemBool: newNonMemBool, email: email},              
                 success: function(data) {    
                 alert(data);
                    var dataArray = data.split('|');
                    ...
                    if(paymentStatus == 1) {
                        ...
                        $('#msgBox5').html('Payment of '+serviceCostText+' successfully processed. '+xtraMsg);
...
//===========================================
alert(ajaxSwitch, memberId,  scheduleId,  bundleId,  classDate,  typeId, locationId, timeSlot);
 if(bookingCount != '0') {
