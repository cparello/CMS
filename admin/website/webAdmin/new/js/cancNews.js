...
$.ajax ({
                 ...
                 async:false,
                 dataType: 'html', 
                 data: {email: email, ajax_switch: ajaxSwitch},               
                 success: function(data) { 
                    //alert(data);
                    if(data == 99){ 
                        $('#msgBox').html('You are not registered for the newsletter with this name and/or email address.');
                            $("#msgBox").css( { "color" : "red"} );
                            return false;
                        }
   //alert(data);                  
                        if(data == 1) {
                            ...
                            //end ajax 
                            $('#msgBox').html('Unsubscrining for the newsletter was successful for '+firstName+' '+lastName+'.');
