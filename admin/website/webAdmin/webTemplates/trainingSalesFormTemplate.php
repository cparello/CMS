...
<script type="text/javascript" src="webScripts/checkTrainingSalesFields.js"></script>
...
<div class="container">
<p class="headerTerms">Personal Training Waiver<span class="plus">+</span></p>
<tr>
<span class="blackBold">I have read Personal Training ASSUMPTION OF RISK, WAIVER AND RELEASE OF LIABILITY, AND
INDEMNITY AGREEMENT DECLARATIONS:&nbsp;</span><input type="checkbox" name="terms_conditions" id="terms_conditions"  value=""/><a href="javascript: void" id="pos2"/><img src="../../images/question-mark.png" class="alignMiddle"></a> 
</tr>
...
<form name="form1" id="form1" action="saveTrainingMember.php" method="post" onSubmit="return checkServices(this.name,this.id)">
