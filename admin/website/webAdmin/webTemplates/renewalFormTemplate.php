...
<script type="text/javascript" src="webScripts/checkRenewalFields.js"></script>
...
<div class="container">
<p class="headerTerms">Terms & Conditions<span class="plus">+</span></p>
<tr>
<span class="blackBold">I have read the Terms & Condiitons:&nbsp;</span><input type="checkbox" name="terms_conditions" id="terms_conditions"  value=""/><a href="javascript: void" id="pos2"/><img src="../../images/question-mark.png" class="alignMiddle"></a> 
</tr>
...
<form name="form1" id="form1" action="saveRenewalMember.php" method="post" onSubmit="return checkServices(this.name,this.id)">

 <div class="verifyPay">
<span id="verifyEft"></span>
</div>   
<div id=\"paymentInfoTab\">
    <span class=\"tabText2\">1. Payment Information</span>
<div id=\"todayPayTwo\">
<br>
