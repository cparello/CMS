...
<center><u>Website Company Mission</u>   </center> 
</td>
</tr>
...
<td>
<input id="missionStatement" type="text" maxlength="100" size="45" value="$missionStatement" name="missionStatement" tabindex="5"></input><a href="javascript: void" id="pos1" onclick="popup_show('popup', 'popup_drag', 'popup_exit', 'element-right',  -100, -50, 'pos1', 1 );" /><img src="../../images/question-mark.png" class="alignMiddle"></a> 
</td>
</tr>

<tr>
<td class="black" width="225">
<center>Company Motto:</center>
</td>
<td>
<input id="motto" type="text" maxlength="100" size="45" value="$motto" name="motto" tabindex="5"></input><a href="javascript: void" id="pos2" onclick="popup_show('popup', 'popup_drag', 'popup_exit', 'element-right',  -100, -50, 'pos2', 2 );" /><img src="../../images/question-mark.png" class="alignMiddle"></a> 
</td>
</tr>
