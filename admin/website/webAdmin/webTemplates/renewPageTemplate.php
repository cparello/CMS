...
<meta name="description" content="$description" />
    ...
    <script src="webScripts/changeRenewalValue.js" type="text/javascript"></script>
...
<div class="inner">
<br>
<p class="caption-header txt-gray"><span style="color: #000000; font-family: $clubInfoFont; font-size:28px;"><b>Join Now</b></p>
<br>
<p class="caption-header txt-gray"><span style="color: #000000; font-family: $clubInfoFont; font-size:28px;"><b>Featured Memberships</b></p>
<br>
<div class="joinBox">
    $divBoxes
    <center><input type='button' value='Renew' id='purchase' class='buttonPurchase buttonPasses$middleButtons buttonSize' field='number_memberships'/><input type='button' value='Go Back' id='back' class='buttonPurchase buttonPasses$middleButtons buttonSize' field='none' onclick="location.href = 'webIndex.php';"/></center>
