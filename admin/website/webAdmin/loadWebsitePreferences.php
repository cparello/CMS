...
$viewedClubName = $_REQUEST['clubName'];
...
$stmt->close();
 ...
 $stmt = $dbMain ->prepare("SELECT header_txt, header_txt2, header_txt3, box_width, text_transform, header_color, back_color, promo_link, photo1, photo2, photo3, photo4, photo5  FROM website_promo WHERE web_key = '1'");
$stmt->execute();      
$stmt->store_result();      
$stmt->bind_result($headerTxt, $headerTxt2, $headerTxt3, $boxSize, $textTrans, $headerColor, $backColor, $promoLink, $photo1, $photo2, $photo3, $photo4, $photo5);
$stmt->fetch();
$stmt->close();
