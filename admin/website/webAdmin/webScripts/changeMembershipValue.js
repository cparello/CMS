...
$('input:radio[name=yearOptions1]:nth(0)').attr('checked',true);
$('input:radio[name=yearOptions2]:nth(0)').attr('checked',true);
$('input:radio[name=yearOptions3]:nth(0)').attr('checked',true);
$('input:radio[name=yearOptions4]:nth(0)').attr('checked',true);
$('input:radio[name=yearOptions5]:nth(0)').attr('checked',true);
$('input:radio[name=yearOptions6]:nth(0)').attr('checked',true);
});
//===================================================================================================
                     ...
                     var totPrice = dataArray[2];
                          ...
                          if(successBit == 1) {                             
                             ...
                             $("#total1").html('$'+totPrice);     
                              if (yearValue1 == 1){
                                $("#pifYears1").html(yearValue1+' Year');   
                             }else{
                                $("#pifYears1").html(yearValue1+' Years');  
                             }               
                            }else{
                     ...
                     var totPrice = dataArray[2];
                          ...
                          if(successBit == 1) {                             
                             ...
                             $("#total2").html('$'+totPrice); 
                              if (yearValue2 == 1){
                                $("#pifYears2").html(yearValue2+' Year');   
                             }else{
                                $("#pifYears2").html(yearValue2+' Years');  
                             }        
                            }else{
                            alert('There was an error!');
                            }                     
                          ...
                          if(successBit == 1) {  
                           // alert('test');
                             ...
                             $("#total3").html('$'+totPrice); 
                              if (yearValue3 == 1){
                                $("#pifYears3").html(yearValue3+' Year');   
                             }else{
                                $("#pifYears3").html(yearValue3+' Years');  
                             }               
                            }else{
                            alert('There was an error!');
                            }                     
                     ...
                     var totPrice = dataArray[2];
                          ...
                          if(successBit == 1) {                             
                             ...
                             $("#total4").html('$'+totPrice);  
                              if (yearValue4 == 1){
                                $("#pifYears4").html(yearValue4+' Year');   
                             }else{
                                $("#pifYears4").html(yearValue4+' Years');  
                             }              
                            }else{
                            alert('There was an error!');
                            }                     
                ...
                data: {ajax_switch: ajaxSwitch, service_name: serviceName, service_quantity: yearValue5},               
                     ...
                     var totPrice = dataArray[2];
                          ...
                          if(successBit == 1) {                             
                             ...
                             if (yearValue5 == 1){
                                $("#pifYears5").html(yearValue5+' Year');   
                             }else{
                                $("#pifYears5").html(yearValue5+' Years');  
                             }            
                            }else{
                            alert('There was an error!');
                            }                     
                ...
                data: {ajax_switch: ajaxSwitch, service_name: serviceName, service_quantity: yearValue6},               
                     ...
                     var totPrice = dataArray[2];
                          ...
                          if(successBit == 1) {                             
                             ...
                             if (yearValue6 == 1){
                                $("#pifYears6").html(yearValue6+' Year');   
                             }else{
                                $("#pifYears6").html(yearValue6+' Years');  
                             }
...
if (totalQuantity == 0){
    alert('Please select a quantity of atleast one membership before clicking Purchase.');
    return false;   
}
var ajaxSwitch = 1;
  ...
  var totSaleArray  = [totalSale1, totalSale2, totalSale3, totalSale4, totalSale5, totalSale6];
   ...
   location.href = 'launchSalesForm.php?number_memberships='+numMembershipArray+'&service_name='+serviceNameArray+'&service_quantity='+yearValueArray+'&service_cost='+totSaleArray+'&ajax_switch='+ajaxSwitch; 
