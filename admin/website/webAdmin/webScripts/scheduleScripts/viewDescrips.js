...
$.ajax ({
                type: "POST",
                url: "schedule/loadClassDescription.php",
                cache: false,
                dataType: 'html', 
             ...
             // alert(data);
                          ...
                          if(successBit == 1) {   
                            window.location = "classDescriptionsPage.php?name="+name+"&description="+description+"&catName="+catName+"";
                                     //$('#classDescription').val("<h2>"+name+"<br><br><h5>"+description+"");
                             }else if(successBit == 2){
                                window.location = "classDescriptionsPage.php?descriptionList="+description+"&catName="+name+"";
                             }
