...
$(document).ready(function() {
  ...
  $(".buttonSubmit").click(function() {
    ...
    var clubId = $('#clubId').val(); 
      alert(clubId);
       if($('#number_new_memberships').val() > 1 && document.getElementById('liability_host').checked == false){
       ...
       //alert(test);
        if(document.getElementById('terms_conditions').checked == false){
           alert('You must read the terms and conditions before proceding.');
           return false;
        }
           ...
           // var license= $(licNumber).val();
            ...
            if(document.getElementById('liability_host').checked == true){
               var firstNameHost = document.getElementById('first_name_lib').value;
            var middleNameHost = document.getElementById('middle_name_lib').value;
            var lastNameHost = document.getElementById('last_name_lib').value;
            var streetAddressHost = document.getElementById('street_address_lib').value;
            var cityHost = document.getElementById('city_lib').value;
            var stateHost = document.getElementById('state_lib').value;
            var zipCodeHost = document.getElementById('zip_code_lib').value;
            var homePhoneHost = document.getElementById('home_phone_lib').value;
            var cellPhoneHost = document.getElementById('cell_phone_lib').value;
            var emailHost = document.getElementById('email_lib').value;
            var dobHost = document.getElementById('dob_lib').value;
                 ...
                 if($("monthDues").val() != 0.00 || $("monthDues").val() != ""){
                  ...
                  if($("rateFee").val() != 0.00){
                    if($('input:radio[name=rateVerify]:checked').val() == undefined || $('input:radio[name=rateVerify]:checked').val() == 'No'){
                        alert('Please read the \"Rate Guarantee Transaction Request:\" and agree to the terms by selecting yes to continue.');
                        return false;
                    ...
                    if($("enhanceFee").val() != 0.00){
                        ...
                        alert('Please read the \" Enhance Fee Transaction Request:\" and agree to the terms by selecting yes to continue.');
                        return false;
                        }
                    }
...
var enhanceCycle = document.getElementById('enhanceEftCycle').value;
var enhanceCycleDate = document.getElementById('enhanceEftCycleDate').value;
var rateEftCycle = document.getElementById('rateEftCycle').value;
var rateAnnualCycleDate = document.getElementById('rateAnnualCycleDate').value;
