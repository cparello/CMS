...
$totalBilling = 0;
               // echo "test";
$stmt999 = $dbMain->prepare("SELECT DISTINCT contract_key, eft_cycle, eft_cycle_date, guarantee_fee FROM member_guarantee_eft WHERE contract_key != '' ORDER BY contract_key ASC");//>=
if(!$stmt999->execute())  {
