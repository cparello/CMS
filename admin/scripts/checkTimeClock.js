...
//this checks to see if any of the check boxes have been checked before submitting
 ...
 if (typeof document.form1.elements['update[]'].length != 'undefined') {

       for (i=0; i< document.form1.elements['update[]'].length; i++) {
             if (document.form1.elements['update[]'][i].checked) { 
                 sel = i;
               }
            }
}else{

       if (document.form1.elements['update[]'].checked) { 
           sel = 1;
           }
} 
 //============================================================
