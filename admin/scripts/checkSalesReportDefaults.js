...
if(salesName == "") {
  ...
  return false;
        ...
        $.ajax ({
                type: "POST",
                url: "runSalesReports.php",
                cache: false,
                dataType: 'text', 
                data: {ajax_switch: ajaxSwitch, club_id: clubId,  group_type: groupType, service_type: serviceType, service_options: serviceTypeOptions, sales_type: salesType, sales_name: salesName, from_date: fromDate, to_date: toDate},               
