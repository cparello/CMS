 ...
 // var prePayTotal = document.form1.prepay_total.value;
  ...
  if(obj.value != "") {
    ...
    var numMonths = obj.value;
          ...
          if(numMonths == 1) {
            var previousTot = document.form1.prepay_total.value;
            if(previousTot == 0 || previousTot == ""){
                    document.form1.prepay_total.value = monthlyPayment;
                    var combinedTot = document.getElementById('prepay_total_combined').value;
                    //alert(combinedTot);
                    if(combinedTot != ""){
                ...
                document.form1.prepay_restart_date.value = singleMonthDate;
                    ...
                    if(previousTot != 0 || previousTot != ""){
                         ...
                         document.getElementById('prepay_total_combined').value = combinedTot - previousTot;
                     }
                         var prePayTotal = numMonths * monthlyPayment; 
                           ...
                           var combinedTot = document.getElementById('prepay_total_combined').value;
                               if(combinedTot != ""){
                                    ...
                                    tot = tot.toFixed(2);
                                document.getElementById('prepay_total_combined').value = tot;
        ...
        var prePayTot = document.getElementById('prepay_total').value;
        if(prePayTot != ""){
        ...
        document.getElementById('prepay_total_combined').value = combinedTot - prePayTot;
         document.form1.prepay_total.value = "";
         document.getElementById('next_payment').innerHTML =  document.getElementById('current_month_date').value;
         document.form1.prepay_restart_date.value = "";
    }

}
//-------------------------------------------------------------------------------------------
function setRatePrePayTotal(obj) {

 // var prePayTotal = document.form1.prepay_total.value;
  var rateFee = document.form1.rate_fee.value;        
  var rateDateArray = document.form1.rate_date_array.value;
  //alert(rateDateArray);
        rateDateArray = rateDateArray.split("|");
        var singleMonthDate = rateDateArray[0];
  ...
  if(obj.value != "") {
    ...
    var numMonths = obj.value;
          ...
          if(numMonths == 1) {
            var previousTot = document.form1.prepay_total_rate.value;
            if(previousTot == 0 || previousTot == ""){
                    document.form1.prepay_total_rate.value = rateFee;
                    var combinedTot = document.getElementById('prepay_total_combined').value;
                    if(combinedTot != ""){
                         combinedTot = parseFloat(combinedTot);
                    }else{
                    ...
                    document.getElementById('prepay_total_combined').value = rateFee + combinedTot;
                    document.getElementById('next_payment_rate').innerHTML = singleMonthDate;
                    document.form1.prepay_restart_date_rate.value = singleMonthDate;
              }else{
                var combinedTot = document.getElementById('prepay_total_combined').value;
                var tempTot = document.form1.prepay_total_rate.value;
                combinedTot = parseFloat(combinedTot);
                tempTot = parseFloat(tempTot);
                    ...
                    if(previousTot != 0 || previousTot != ""){
                     ...
                     var prePayTotal = numMonths * rateFee;
                      var combinedTot = document.getElementById('prepay_total_combined').value;
                            ...
                            document.getElementById('prepay_total_combined').value = tot;
                           prePayTotal = prePayTotal.toFixed(2);
                           document.form1.prepay_total_rate.value = prePayTotal;
                           
                     
                     var dateArrayLength = rateDateArray.length;
                           dateArrayLength = dateArrayLength - 1;
                    //alert(dateArrayLength);
                      for(var i=0; i <= dateArrayLength; i++) {                    
                                if(obj.value == i) {
                                   var dateVal = rateDateArray[i-1];
                                         document.getElementById('next_payment_rate').innerHTML = dateVal;
                                         document.form1.prepay_restart_date_rate.value = dateVal;
                                  }            
                           }
        ...
        var prePayTot = document.getElementById('prepay_total_rate').value;
        if(prePayTot != ""){
                             prePayTot = parseFloat(prePayTot);
                        }else{
                         prePayTot = 0;
        ...
        document.getElementById('prepay_total_combined').value = combinedTot - prePayTot;
         document.form1.prepay_total_rate.value = "";
         document.getElementById('next_payment_rate').innerHTML =  document.getElementById('current_rate_date').value;
         document.form1.prepay_restart_date_rate.value = "";
    }

}
//-------------------------------------------------------------------------------------------
function setEnhancePrePayTotal(obj) {

 // var prePayTotal = document.form1.prepay_total.value;
  var enhanceFee = document.form1.enhance_fee.value;        
  var enhanceDateArray = document.form1.enhance_date_array.value;
  //alert(rateDateArray);
        enhanceDateArray = enhanceDateArray.split("|");
        var singleMonthDate = enhanceDateArray[0];
  ...
  if(obj.value != "") {
    ...
    var numMonths = obj.value;
          ...
          if(numMonths == 1) {
            var previousTot = document.form1.prepay_total_enhance.value;
            if(previousTot == 0 || previousTot == ""){
                    document.form1.prepay_total_enhance.value = enhanceFee;
                    var combinedTot = document.getElementById('prepay_total_combined').value;
                    if(combinedTot != ""){
                         combinedTot = parseFloat(combinedTot);
                    }else{
                    ...
                    document.getElementById('prepay_total_combined').value = enhanceFee + combinedTot;
                    document.getElementById('next_payment_enhance').innerHTML = singleMonthDate;
                    document.form1.prepay_restart_date_enhance.value = singleMonthDate;
                }else{
                var combinedTot = document.getElementById('prepay_total_combined').value;
                var tempTot = document.form1.prepay_total_enhance.value;
                combinedTot = parseFloat(combinedTot);
                tempTot = parseFloat(tempTot);
                    ...
                    if(previousTot != 0 || previousTot != ""){
                     ...
                     var prePayTotal = numMonths * enhanceFee; 
                      ...
                      var tot = prePayTotal + combinedTot;
                            ...
                            document.getElementById('prepay_total_combined').value = tot;
                           prePayTotal = prePayTotal.toFixed(2);
                           document.form1.prepay_total_enhance.value = prePayTotal;
                           
                          
                     
                     
                     var dateArrayLength = enhanceDateArray.length;
                           dateArrayLength = dateArrayLength - 1;
                    //alert(dateArrayLength);
                      for(var i=0; i <= dateArrayLength; i++) {                    
                                if(obj.value == i) {
                                   var dateVal = enhanceDateArray[i-1];
                                         document.getElementById('next_payment_enhance').innerHTML = dateVal;
                                         document.form1.prepay_restart_date_enhance.value = dateVal;
                                  }            
                           }
        ...
        var prePayTot = document.getElementById('prepay_total_enhance').value;
        if(prePayTot != ""){
                             prePayTot = parseFloat(prePayTot);
                        }else{
                         prePayTot = 0;
        ...
        document.getElementById('prepay_total_combined').value = combinedTot - prePayTot;
         document.form1.prepay_total_enhance.value = "";
         document.getElementById('next_payment_enhance').innerHTML =  document.getElementById('current_enhance_date').value;
         document.form1.prepay_restart_date_enhance.value = "";
    }

}
//-------------------------------------------------------------------------------------------
function setMaintPrePayTotal(obj) {

 // var prePayTotal = document.form1.prepay_total.value;
  var mFee = document.form1.m_fee.value;        
  var mDateArray = document.form1.m_date_array.value;
  //alert(rateDateArray);
  ...
  if(obj.value != "") {
    ...
    var numMonths = obj.value;
          ...
          if(numMonths == 1) {
            var previousTot = document.form1.prepay_total_m.value;
            if(previousTot == 0 || previousTot == ""){
                    document.form1.prepay_total_m.value = mFee;
                    var combinedTot = document.getElementById('prepay_total_combined').value;
                    if(combinedTot != ""){
                         combinedTot = parseFloat(combinedTot);
                    }else{
                    ...
                    document.getElementById('prepay_total_combined').value = mFee + combinedTot;
                    document.getElementById('next_payment_m').innerHTML = singleMonthDate;
                    document.form1.prepay_restart_date_m.value = singleMonthDate;
            }else{
                var combinedTot = document.getElementById('prepay_total_combined').value;
                var tempTot = document.form1.prepay_total_m.value;
                combinedTot = parseFloat(combinedTot);
                tempTot = parseFloat(tempTot);
                    ...
                    if(previousTot != 0 || previousTot != ""){
                     ...
                     var prePayTotal = numMonths * mFee;
                      ...
                      var tot = prePayTotal + combinedTot;
                            ...
                            document.getElementById('prepay_total_combined').value = tot;
                           prePayTotal = prePayTotal.toFixed(2);
                           document.form1.prepay_total_m.value = prePayTotal;
                      ...
                      for(var i=0; i <= dateArrayLength; i++) {                    
                                if(obj.value == i) {
                                   var dateVal = mDateArray[i-1];
                                         document.getElementById('next_payment_m').innerHTML = dateVal;
                                         document.form1.prepay_restart_date_m.value = dateVal;
                                  }            
                           }
        ...
        var prePayTot = document.getElementById('prepay_total_m').value;
        if(prePayTot != ""){
                             prePayTot = parseFloat(prePayTot);
                        }else{
                         prePayTot = 0;
        ...
        document.getElementById('prepay_total_combined').value = combinedTot - prePayTot;
         document.form1.prepay_total_m.value = "";
         document.getElementById('next_payment_m').innerHTML =  document.getElementById('current_m_date').value;
         document.form1.prepay_restart_date_m.value = "";
    }
...
var prePayTotal = document.form1.prepay_total.value;
var prePayTotalRate = document.form1.prepay_total_rate.value;
var prePayTotalEnhance = document.form1.prepay_total_enhance.value;
var prePayTotalMaint = document.form1.prepay_total_m.value;
var numMonths = document.form1.num_months.value;
var contractKey = document.form1.contract_key.value;
var prePayCombinedTotal = document.form1.prepay_total_combined.value;

var pastFlag = document.form1.past_due_flag.value;
//alert(creditFieldValue);

     if(pastFlag == "1") {
         var answer = confirm("This account is currently past due.  Do you wish to continue?");
             if (!answer) {
             return false;
                }          
        }
 ...
 if(prePayTotal == "" && prePayTotalRate == "" && prePayTotalEnhance == "" && prePayTotalMaint == "" ) {
    alert('Please select a value from one of the \"Prepaid Months\" drop down menus');
            return false;                                         
   }
         ...
         alert('Please enter the check number');
          ...
          var checkNumberBool = checkNan(checkNumber,checkNumberFieldName);
                 if(checkNumberBool == false) {
                    ...
                    prePayCombinedTotal = parseFloat(prePayCombinedTotal);
               ...
               var paymentTotal = creditFieldValue + achFieldValue + cashFieldValue + checkFieldValue;      
                   ...
                   if(paymentTotal < prePayCombinedTotal)  {
