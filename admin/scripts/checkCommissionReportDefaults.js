...
//return false;
        ...
        $.ajax ({
                type: "POST",
                url: "runCommissionReports.php",
                cache: false,
                dataType: 'text', 
                data: {ajax_switch: ajaxSwitch, club_id: clubId,  employee_type: employeeType, employee_name: employeeName, service_type: serviceType,    from_date: fromDate, to_date: toDate},               
