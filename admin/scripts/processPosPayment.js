...
//---------------------------------------------------------
function parsePurchase(transactionId, cardName, cardNumber, total, cardMonth, cardYear) {
...
var ajaxSwitch = 1;
 ...
 $.ajax ({
                 ...
                 async: false,
                 dataType: 'html', 
                 data: {bar_code_array: barCodeArray, purchase_cost: purchaseCost, ajax_switch: ajaxSwitch, transaction_id: transactionId, cardName: cardName, cardNumber: cardNumber, total: total, cardMonth: cardMonth, cardYear: cardYear, contractKey: contractKey},              
...
var total = creditPay;
    ...
    $.ajax ({
                 ...
                 async: false,
                 dataType: 'html', 
                 data: {credit_payment: creditPay, card_type: cardType, card_number: cardNumber, card_name: cardName, card_cvv: cardCvv, card_month: cardMonth, card_year: cardYear, contract_key: contractKey, cash_payment: cashPay, check_payment: checkPay, contractKey: contractKey},              
                 success: function(data) {    
                //alert(data);
                    var dataArray = data.split('|');
                    ...
                    if(paymentStatus == 1) {
                             ...
                             parsePurchase(transactionId, cardName, cardNumber, total, cardMonth, cardYear);
