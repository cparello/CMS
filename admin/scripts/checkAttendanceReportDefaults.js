...
if(attendanceType == "") {
  ...
  $("#attendance_type").focus();
    return false;
        ...
        $.ajax ({
                type: "POST",
                url: "runClubAttendanceReports.php",
                cache: false,
                dataType: 'text', 
                data: {ajax_switch: ajaxSwitch, attendance_type: attendanceType, service_location: serviceLocation, from_date: fromDate, to_date: toDate},               
