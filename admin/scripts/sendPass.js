function sendPass(linkBit) {

var userName = prompt("Please enter  your \"Username\" in the field below.\nYour email address will be emailed to you shortly.\n\n")
...
if(linkBit == 1) {
 var appLink = 'helper_apps/sendPass.php';
 }
if(linkBit == 2) {
 var appLink = '../helper_apps/sendPass.php';
 }
...
if(passStatus == 2)  {
 alert('Your Password has been successfully emailed to "' +userName+ '"');   
}
