...
switch(ht)   {
case 199:
   helpText = "This can be set to All mode or Current Mode. \"All\" will update every credit card in the database, \"Current\" will only update active monthly accounts.";                      
   return helpText;  
break;
case 1:
   helpText = "This can be set to TEST mode or LIVE Mode.";                      
   return helpText;  
break;
case 2:
