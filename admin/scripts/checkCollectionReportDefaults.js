...
if(collectionType == "") {
  ...
  return false;
   ...
   var collectionCategory = $("#colCat").val();
        ...
        $.ajax ({
                type: "POST",
                url: "runCollectionReportsTwo.php",
                cache: false,
                dataType: 'text', 
                data: {ajax_switch: ajaxSwitch, collection_category: collectionCategory, collection_type: collectionType, from_date: fromDate, to_date: toDate},               
