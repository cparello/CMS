...
var payField = document.form1.elements[fieldName];  
var adjustVal = document.form1.elements[fieldName][2].value;


//this checks also that there is not a m to m upgrade field
if (payField[0]) {
          for (var i=0; i< payField.length; i++) {
          
                  if(payField[2].value == 0 || payField[2].value == "NA") {            
