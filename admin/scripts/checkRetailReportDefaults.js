...
if(productBar == "") {
  ...
  return false;
        ...
        $.ajax ({
                type: "POST",
                url: "runRetailReports.php",
                cache: false,
                dataType: 'text', 
                data: {ajax_switch: ajaxSwitch, club_id: clubId,  category_type: categoryType, product_bar: productBar, from_date: fromDate, to_date: toDate},               
