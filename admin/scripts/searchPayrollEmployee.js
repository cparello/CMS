...
var date1 = document.form1.datepicker1.value;
var date2 = document.form1.datepicker2.value;

if (date1 == ""){
    txt.innerHTML= '<span class="errors">Please Select a starting date range.</span>';
       datepicker1.focus();                          
       return false;
}
if (date2 == ""){
    txt.innerHTML= '<span class="errors">Please Select a ending date range.</span>';
       datepicker2.focus();                          
       return false;
}
var searchStrng = "";
