...
//---------------------------------------------------------------------------------------------------------------------------------------------
function newMemberFormSchedule() {

//check to see if a contract id has been generated
if(document.form1.contract_key.value != "") {
  alert('WARNING!  You must submit or cancel this Contract before switching to the scheduler. To submit this Contract please use the "Step 2 Submit Order" button below.  If you wish to cancel this order,  please use the "Cancel Contract" button at the bottom of this page to start over.');
  document.form1.cancel_contract.focus();
  return false; 
  }else{
  window.location = "scheduleUpdate.php";
  }
...
function getMemberNumber()   {
              ...
              var memberNumber = document.form1.mem_num
              .value;
                    if(memberNumber == "") {
                      memberNumber = 1;
                     }
