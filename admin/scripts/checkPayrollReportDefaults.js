...
//return false;
        ...
        $.ajax ({
                type: "POST",
                url: "runPayrollReports.php",
                cache: false,
                dataType: 'text', 
                data: {ajax_switch: ajaxSwitch, club_id: clubId,  payment_cycle: paymentCycle, comp_type: compType, emp_type: empType, ot_type: otType,   from_date: fromDate, to_date: toDate},               
