...
$.ajax ({
            ...
            data: {item_array: checkBoxArray, type_list: typeList, return_reason: returnReason, ajax_switch: ajaxSwitch},               
                 ...
                 if(test == "1" && test2 == "1") {
                    ...
                    alert(typeListTextCaps+ ' successfully recorded. Amount refunded to Account used.'); 
                   ...
                   }else if(test == "2" && test2 == "3") {
                    alert(typeListTextCaps+ ' successfully recorded. Amount refunded to account FAILED!'); 
