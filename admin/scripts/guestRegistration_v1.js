...
var quoted_price = $("#quoted_price").val();
 ...
 if(quoted_price == ""){
		    alert("You have not entered an valid membership quote");
            $("#quoted_price").focus();
		    return false;		 
         }
var ajaxSwitch = 1;
...
$.ajax ({
                 ...
                 async:false,
                 dataType: 'html', 
                 data: {pass_id: passId, duration: radVal, guest_name: guestName, guest_phone: formattedPhoneNumber, guest_email: guestEmail, interest_one: interestOne, interest_two: interestTwo, ajax_switch: ajaxSwitch, quoted_price: quoted_price},               
                 success: function(data) {    
   //alert(data);                  
                if(data == 99){
...
$("#guest_list").live("click", function(event) {
 ...
 if(searchType == "X" ||  searchString == "") {
    alert('Please select a search type and enter a search parameter before clicking search.');
            return false;
        ...
        $.ajax ({
                   ...
                   async:false,
                   dataType: 'html', 
                   data: {ajaxSwitch: ajaxSwitch, searchString: searchString, searchType: searchType},               
                   success: function(data) {   
