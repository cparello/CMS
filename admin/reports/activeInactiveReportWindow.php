...
$club_name = $_SESSION['service_location'] ;
$category_name = $_SESSION['category_type'];
...
if($category_name == "Attrition Comparison") {
   $header_rows ="    
    <tr>
...
if($category_name == "Active Accounts") {
   $header_rows ="    
    <tr>
    <td class=\"projHeader pSpace1\">
    Period
...
if($category_name == "Inactive Accounts") {
   $header_rows ="    
    <tr>
    <td class=\"projHeader pSpace1\">
    Period
...
<title>Active Inactive Report</title>
