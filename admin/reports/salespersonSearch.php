...
include "salespersonList.php";
$getLists = new salesLists();
...
include "../templates/salespersonListTemplate.php";
exit;
}
...
$javaScript1 = "<script type=\"text/javascript\" src=\"../scripts/searchSalespersonEmployee.js\"></script>";
...
include "../templates/searchSalespersonTemplate.php";
