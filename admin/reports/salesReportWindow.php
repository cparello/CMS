...
$service_type_name = $_SESSION['service_type_name'];
$service_type_options_name = $_SESSION['service_type_options_name'];
$sales_type = $_SESSION['sales_type'];
...
unset($_SESSION['service_type_name']);
unset($_SESSION['service_type_options_name']);
unset($_SESSION['sales_type']);
unset($_SESSION['sales_name']);
