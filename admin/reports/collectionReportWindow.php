...
$collection_type_index = $_SESSION['collection_type_index'];
...
unset($_SESSION['collection_type_index']);
unset($_SESSION['summary_rows']);
unset($_SESSION['print_chart']);


switch($collection_type_index) {
        case "P":         
        $collectionCategoryLable = 'Collection Attempts';
        $parHeader1 = 'Accounts Past Due';
        $parHeader2 = 'Total Past Due';
        $parHeader3 = 'Past Due Projected';  
        break;
        case "D":
        $collectionCategoryLable = 'Transaction Type';
        $parHeader1 = 'Declined Transactions';
        $parHeader2 = 'Declined Total';
        $parHeader3 = 'Declined Projected';  
        break;
        case "I":
        $collectionCategoryLable = 'Club Location';
        $parHeader1 = 'Balance Due';
        $parHeader2 = 'Due Total';
        $parHeader3 = 'Due Projected'; 
        break;
     }
