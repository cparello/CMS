...
$payment_cycle_name = $_SESSION['payment_cycle_name'];
$compensation_name = $_SESSION['compensation_name'];
$employee_type_name = $_SESSION['employee_type_name'];
$ot_type_name = $_SESSION['ot_type_name'];
...
unset($_SESSION['payment_cycle_name']);
unset($_SESSION['compensation_name']);
unset($_SESSION['employee_type_name']);
unset($_SESSION['ot_type_name']);
