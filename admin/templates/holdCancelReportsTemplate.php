...
<div id="savedDrop">
<img style="vertical-align:middle" src="../images/star.png"border="0"\> <span class="black">My Saved Hold/ Cancelation Reports</span>
&nbsp;
<select  name="savedDropSales" id="savedDropSales" class="black3"/>
<option value>Select Hold Cancel Report</option>
$report_drops
</select>
</div>
...
<span class="black">1.  Hold/ Cancelation Type</span>
&nbsp;
<select name="hc_type" id="hc_type" class="black3"/>
<option value>Select Hold CanceType</option>
<option value="CO">Cool Off Cancelation</option>
<option value="CA">Service Cancelation</option>
<option value="SH">Service Hold</option>
<option value="MH">Member Hold</option>
</select>
</td> 
