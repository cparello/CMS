    ...
    <form name="form1" id="form1" action="saveMember.php" method="post" onSubmit="return checkServices(this.name,this.id)">
        ...
        <table width="100%">
          <tr>
            ...
            <td align="left" class="black">
              <b>Contract Start Date:</b> &nbsp;<input type="text" id="datepicker" size="10" value="$class_date" />
            </td>
          ...
          <div id="oBox2" class="monthly2">
            <table width="100%">
              ...
              <tr>
                ...
                <td>
                  <input name="init_fee" type="text" id="init_fee" value="" size="8" maxlength="8" onKeyUp="return parseInitFee(this.value,this.name)" disabled="disabled"/>
                </td>
              </tr>
            </table>
          </div>
        ...
        <table width="100%">
          <tr>
            ...
            <td class="black" align="left">
              ...
              <input name="due_date" type="text" id="due_date" value="$balance_due_date" size="22" maxlength="22"  tabindex="18" disabled="disabled" />
            </td>
          </tr>
        </table>
      </div>
      ...
      <table width="90%">
        ...
        <tr>
          <td>
            <br />
            <span class="black">Liability Host:</span><input type="checkbox" name="liability_host" id="liability_host" value="1"  onClick="setLiabilityHost();" />
          </td>
        </tr>
      </table>
        ...
        <div id="creditPay2" class="creditPay2">
          <table id="secTab" align="center" cellpadding="2">
            ...
            <tr>
              ...
              <td>
                <input  name="card_name" type="text" id="card_name" value="" size="25" maxlength="100" onFocus="return checkServices(this.name,this.id)"$credit_disabled1/>
              </td>
            </tr>
            <tr>
              <td class="black">
        ...
        <div id="printCont">
          <table align="center" cellpadding="2" class="submitTable">
            <tr>
              ...
              <td align="center" valign="top" style="padding: 10px;">
                <input type="submit" class="submit_button" style="border: 0px;" name="save" id="save" value="" />
              </td>
              <td align="center" valign="top" style="padding: 10px;">
