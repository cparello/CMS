...
<td>
<textarea cols="26" rows="5" name="type_description" id="type_description">$type_description</textarea><a href="javascript: void" id="pos2" onclick="popup_show('popup', 'popup_drag', 'popup_exit', 'element-right',  -25, -85, 'pos2', 2 );" /><img src="../images/question-mark.png" class="alignTop"></a>    
<td>
</tr>
