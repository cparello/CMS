<?php
$searchInventoryTemplate = <<<SEARCHINVENTORY
...
$javaScript4
	...
	<title>Search Edit Inventory</title>
...
<div id="userForm1">
<form id="form1" name="form1" method="post" action="searchInventory.php" >
