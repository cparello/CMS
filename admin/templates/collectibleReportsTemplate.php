<?php
$retailReportsTemplate = <<<RETAILREPORTSTEMPLATE
...
<div id="savedDrop">
<img style="vertical-align:middle" src="../images/star.png"border="0"\> <span class="black">My Saved Collection Reports</span>
&nbsp;
<select  name="savedDropSales" id="savedDropSales" class="black3"/>
<option value>Select Collection Report</option>
$report_drops
</select>
</div>
...
<span class="black">1. Collection Category</span>
&nbsp;
<select name="collection_type" id="collection_type" class="black3"/>
<option value>Select Collection Category</option>
<option value="P">Past Due Accounts</option>
<option value="D">Declined/ Rejected Transactions</option>
<option value="I">Initial Payments Balance Due</option>
</select>
</td> 
<td class="cSpace" id="colDrops" colspan="2">
<span class="black" id="colLable"></span>
&nbsp;
<select name="collection_category" id="colCat" class="black3"/>
</select>
</td> 
</tr>
...
RETAILREPORTSTEMPLATE;


echo"$retailReportsTemplate";
