...
<div id="userForm">
<form name="form1" method="post" action="addInstructorsRooms.php">
...
<option value>Add Instructor Room</option>
<option value="I">Add Instructor</option>
<option value="R">Add Room</option>
</select>
</td>
</tr>
...
<input type="submit" id="button1" class="button1" name="button1" value="Add" />
