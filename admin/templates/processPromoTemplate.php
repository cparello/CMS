...
<title>Process Promo Re-enrollment</title>
...
<div id="userHeader">
Process Promo Accounts
</div>


<div id="innerOne">
<span class="grey">
<u>Promo Accounts</u><a href="javascript: void" id="pos9" onclick="popup_show('popup', 'popup_drag', 'popup_exit', 'element-right',  -100, 0, 'pos9', 9);" /><img src="../images/question-mark.png" class="alignMiddle"></a>
</span>
</div>
...
<th align="center" class="black pTop">SMS</th>
</tr>
<tr>
...
<td align="center" class="black"><input type="radio" name="er" id="er4" value="sms"></td>
</tr>

<tr>
<td align="right" class="black top2">
Select Expired Date Range
</td>
...
<tr>
<td align="right" class="black top2">
Select Renewal Date Range
</td>
<td align="center" class="black top2" colspan="2">
<select  name="rn_range" id="rn_range"/>
<option value="30" selected>30 Days</option>
<option value="60">60 Days</option>
<option value="90">90 Days</option>
</select>
...
<input type="button" name="per"  id="per" class="button1" value="Process Promo"/>
</td>
</tr>
</table>
</div>
