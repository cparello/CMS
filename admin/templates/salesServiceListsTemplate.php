...
Contract Start Date: &nbsp;<span class="black"><input type="text" id="datepicker" size="10" value="$class_date" /></span>
</td>
...
<td>
<input name="down_pay" type="text" id="down_pay" value="" size="8" maxlength="8" onFocus="return checkMonthlyService();" onKeyUp="return parseDownPay(this.value,this.name);"/>
</td>
</tr>
<tr>
<td class="black">
...
<td>
<input name="monthly_payment" type="text" id="monthly_payment" value="$monthly_payment" size="8" maxlength="8" disabled="disabled"/>
</td>
</tr>
<tr>
<td class="black">
...
<td class="black" align="left">
Todays Payment:&nbsp;
<input name="today_payment" type="text" id="today_payment" value="" size="8" maxlength="8"  onKeyUp ="setTodaysPayment(this.value); return checkNan(this.value,this.name);"  onFocus="return checkServices(this.name, this.id);"/>
</td>
<td class="black" align="left">
Balance Due:&nbsp;
...
<td>
<input  name="card_name" type="text" id="card_name" value="" size="25" maxlength="300" onFocus="return checkServices(this.name,this.id)" $credit_disabled1/>
</td>
</tr>
<tr>
<td class="black">
...
<td>
<input  name="card_number" type="text" id="card_number" value="" size="25" maxlength="25" onFocus="return checkServices(this.name,this.id)"$credit_disabled1/>
</td>
</tr>
<tr>
<td class="black">
...
<td>
<input  name="bank_name" type="text" id="bank_name"  value="" size="25" maxlength="100" onClick="return checkServices(this.name,this.id)"$ach_disabled1/>
</td>
</tr>
<tr>
<td class="black">
...
<td>
<input name="account_num" type="text" id="account_num" value="" size="25" maxlength="25" onClick="return checkServices(this.name,this.id)"$ach_disabled1/>
</td>
</tr>
<tr>
<td class="black">
...
<td>
<input name="check_pay" type="text" id="check_pay" value="" size="12" maxlength="10" onClick="return checkServices(this.name,this.id)"$check_disabled1/>
&nbsp;
