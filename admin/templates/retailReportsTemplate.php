...
<div id="savedDrop">
<img style="vertical-align:middle" src="../images/star.png"border="0"\> <span class="black">My Saved Retail Reports</span>
&nbsp;
<select  name="savedDropSales" id="savedDropSales" class="black3"/>
<option value>Select Retail Report</option>
$report_drops
</select>
</div>
...
<td class="cSpace">
<span class="black">2. Retail Category</span>
&nbsp;
<select name="retail_category" id="retail_category" class="black3"/>
$category_drops
</select>
</td> 
<td class="cSpace">
<span class="black">3. Product Name</span>
&nbsp;
<select name="product" id="product" class="black3"/>
