<?php
$commissionReportsTemplate = <<<COMREPORTSTEMPLATE
...
<div id="savedDrop">
<img style="vertical-align:middle" src="../images/star.png"border="0"\> <span class="black">My Saved Commission Reports</span>
&nbsp;
<select  name="savedDropSales" id="savedDropSales" class="black3"/>
<option value>Select Commission Report</option>
$report_drops
</select>
</div>
...
<td class="cSpace">
<span class="black">2. Employee Type</span>
&nbsp;
...
<td class="cSpace">
<span class="black">3. Employee Name</span>
&nbsp;
<select name="employee_name" id="employee_name" class="black3"/>
<option value>Select Employee</option>
</select>
</td> 
</tr>
<tr>
<td class="lPad cSpace tPad" colspan="2">
<span class="black">4. Service Type</span>
&nbsp;
...
<span class="black">5. Date Range (Optional)</span>
&nbsp;
...
echo"$commissionReportsTemplate";
