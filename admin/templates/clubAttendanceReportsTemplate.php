<?php
$clubAttendanceReportsTemplate = <<<CLUBATTENDANCEREPORTSTEMPLATE
...
<div id="savedDrop">
<img style="vertical-align:middle" src="../images/star.png"border="0"\> <span class="black">My Saved Club Attendance Reports</span>
&nbsp;
<select  name="savedDropSales" id="savedDropSales" class="black3"/>
<option value>Select Club Attendance Report</option>
$report_drops
</select>
</div>
...
<span class="black">2. Attendance Category</span>
&nbsp;
<select name="attendance_type" id="attendance_type" class="black3"/>
<option value>Select Attendance Category</option>
<option value="AA">All Attendance</option>
<option value="SA">Service Member Attendance</option>
<option value="MA">Member Attendance</option>
<option value="GP">Guest Pass Attendance</option>
</select>
</td> 
</tr>
...
<span class="black">3. Date Range (Optional)</span>
&nbsp;
...
CLUBATTENDANCEREPORTSTEMPLATE;


echo"$clubAttendanceReportsTemplate";
