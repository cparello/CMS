<?php
$classAttendanceReportsTemplate = <<<CAREPORTSTEMPLATE
...
<div id="savedDrop">
<img style="vertical-align:middle" src="../images/star.png"border="0"\> <span class="black">My Saved Class Attendance Reports</span>
&nbsp;
<select  name="savedDropSales" id="savedDropSales" class="black3"/>
<option value>Select Class Attendance Report</option>
$report_drops
</select>
</div>
...
<td class="cSpace">
<span class="black">2. Schedule Type</span>
&nbsp;
...
<td class="cSpace">
<span class="black">3. Class Name</span>
&nbsp;
<select name="class_name" id="class_name" class="black3"/>
...
echo"$classAttendanceReportsTemplate";
