...
<td>
<input tabindex= "1" name="standard_renewal_grace" type="text" id="standard_renewal_grace" value= "$standard_renewal_grace" size="10" maxlength="2" onFocus="killHeader()"/><a href="javascript: void" id="pos19" onclick="popup_show('popup', 'popup_drag', 'popup_exit', 'element-right',  -100, -50, 'pos19', 19);" /><img src="../images/question-mark.png" class="alignMiddle"></a>    
</td>
<td width="20">
</td>
<td class="black">
