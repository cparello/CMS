...
<body>
	...
	<tr>
	<td colspan="3">
	 <span class="memberNumberHeader">Member ID:&nbsp;&nbsp;</span>
     <span class="memberNumber">$member_id</span>
	</td>
	</tr>
    <tr>
	<td colspan="3">
	 <span class="memberNumberHeader">Member Name:&nbsp;&nbsp;</span>
     <span class="memberNumber">$first_name $middle_name $last_name</span>
	</td>
	</tr>
	...
	<script language="JavaScript">
		webcam.set_api_url( 'test.php?member_id=$member_id' );
