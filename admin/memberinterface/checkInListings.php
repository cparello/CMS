...
$getText -> setTextNum(42);
$info_text = $getText -> createTextInfo();
include "../templates/infoTemplate2.php";

$javaScript1 = "<script type=\"text/javascript\" src=\"../scripts/jqueryNew.js\"></script>";
$javaScript2 = "<script type=\"text/javascript\" src=\"../scripts/parseCheckInListings.js\"></script>";



include "../templates/setCheckInHistoryTemplate.php";
