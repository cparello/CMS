...
//===================================================================================================
function doVaultAch($payTypeFlag, $vaultFunction, $vaultId, $checkName, $bankRoutingNumber, $bankAccountNumber, $account_holder_type, $account_type, $merchField1, $orderId, $secCode) {
    ...
    $query .= "payment=" . urlencode($payTypeFlag) . "&";
    //check
    $query .= "sec_code=" . urlencode($secCode) . "&";
    $query .= "orderid=" . urlencode($orderId) . "&";
