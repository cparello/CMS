...
$counter = 1;
$total = 0;
$stmt = $dbMain->prepare("SELECT contract_key, billing_amount, transaction_type, processor_response FROM batch_recurring_records WHERE payment_type = '$this->feeType' AND cycle_start_month = '$this->month' AND cycle_start_year = '$this->year' AND cycle_start_day = '$this->day' $pass");
$stmt->execute();      
$stmt->store_result();      
