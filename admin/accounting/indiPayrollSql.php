...
class  indiPayrollSql {

private $userId = null;
private $typeKey = null;
private $recSalt = null;
private $payrollRecord = null;
...
private $radioCheckOneD = null;
private $radioCheckOneA = null;
private $radioCheckTwoD = null;
private $radioCheckTwoA = null;
private $radioCheckThreeD = null;
private $radioCheckThreeA = null;
private $recurseCheckOne = null;
private $recurseCheckTwo = null;
private $recurseCheckThree = null;
private $recurseCheckFour = null;
...
$stmt99 = $dbMain ->prepare("SELECT timeclock_key, user_id, clock_in, clock_out FROM timeclock WHERE  id_card='$this->idCard' ");//AND (clock_out BETWEEN  '$this->dateStart' AND '$this->dateEnd')
$stmt99->execute();      
$stmt99->store_result();      
...
if($rowCount != 0)  {
           ...
           while ($stmt99->fetch()) { 
                ...
                //echo "$day1     $day2 $clock_in $clock_out<br>";
...
function calculateDailyOT(){
    ...
    //echo"idcard $this->idCard dHours $this->dailyHours  dMins $this->dailyMins dsecs $this->dailySecs  RULE $ot_hourly_state_rule";
...
function calcWeeklyOT(){
    ...
    switch ($this->paymentCycle) {
            ...
            case "W":
                 if($dayOfWeek <= 7) {                        
                        $this->closeDate = date('Y-m-d', strtotime( 'This Saturday'));
                   }
                    $date = explode('-',$this->closeDate);
                    $firstday1 = date("Y-m-d H:i:s"  ,mktime(0, 0, 0, $date[1], $date[2]-7, $date[0]));
                    $endweek1 =  date("Y-m-d H:i:s"  ,mktime(23, 59, 59, $date[1], $date[2], $date[0]));
            ...
            case "B";
                 if(($dayOfMonth <= 20) AND ($dayOfMonth > 5)){
                    $this->closeDate = date("Y-m-d"  ,mktime(23, 59, 59, date('m'), 14, date('Y')));
                    //$dateArray = explode("-",$this->closeDate);  //////////////////testing
                    //$this->closeDate = "2012-08-$dateArray[2]";  // testing     
                    }elseif($dayOfMonth <= 5){
                      $this->closeDate = date("Y-m-d"  ,mktime(23, 59, 59, date('m')-1, $endOfMonth, date('Y')));
                      //echo "ccd2  $this->closeDate";
                        //$dateArray = explode("-",$this->closeDate);  //////////////////testing
                    //$this->closeDate = "2012-08-$dateArray[2]";  // testing             
                    }else{
                        $this->closeDate = date("Y-m-d"  ,mktime(23, 59, 59, date('m'), $endOfMonth, date('Y')));
                          //$dateArray = explode("-",$this->closeDate);  //////////////////testing
                    //$this->closeDate = "2012-08-$dateArray[2]";  // testing     
                    }
                   ...
                   // echo "dayStart  $dayStart  dayEnd   $dayEnd<br>";
                            ...
                            $stmt = $dbMain ->prepare("SELECT clock_in, clock_out FROM timeclock WHERE clock_out BETWEEN '$dayStart'  AND '$dayEnd' AND id_card ='$this->idCard'");
                             ...
                             if($rowCount != 0)  {
                                    while ($stmt->fetch()) {
                                        // echo "cin $clock_in, cout $clock_out<br>";
                                        $datetime1 = new DateTime($clock_in);
                                        $datetime2 = new DateTime($clock_out);
                                        $interval = $datetime1->diff($datetime2);
                                        $hoursMinsSecs = $interval->format('%H:%I:%S');                        
...
$sHtml = "
<tr class=\"payInfo\">
<td class=\"grey1 tile6\">
Sales Total
</td>
<td class=\"grey1 tile7\">
$$this->bonusTotSales
</td>
</tr>
<tr class=\"payInfo\">
...
if ($this->ptTotal != '0'){
    $phtml = "<tr class=\"payInfo\">
<td class=\"grey1 tile6\">PT Total</td>
<td class=\"grey1 tile7\">$$this->ptTotal</td>
</tr>
<tr class=\"payInfo\">
<td class=\"grey1 tile6\">PT Performance Bonus</td>
<td class=\"grey1 tile7\">$$this->extraPerformanceMoney</td>
</tr>";
}else{
    $phtml = "";
}
...
if ($this->ptTotalTA != '0'){
    $ahtml = "<tr class=\"payInfo\">
<td class=\"grey1 tile6\">Assesment Total</td>
<td class=\"grey1 tile7\">$$this->ptTotalTA</td>
</tr>";
}else{
    $ahtml = "";
}

$this->payrollRecord = <<<RECORDRESULTS
<div class="serviceList">
<p class="header2">$this->empFullName &nbsp; $this->employeeType $this->clubName <span class="plus">+</span></p>
<div class="listContent">
<table id="secTab2" align="center" cellpadding="2" class="tabBoard4"> 
<tr class="tabHead1">
<td colspan="2" class="oBtext tileS1">
Payment Information
</td> 
</tr>
<tr class="payInfo">
<td class="grey1 tile6 padTop">Commission</td>
<td class="grey1 tile7 padTop">$$this->commissionTotal</td>
</tr>
<tr class="payInfo">
<td class="grey1 tile6 padTop">Commission Returned</td>
<td class="grey1 tile7 padTop">$$this->commissionReturnTotal</td>
</tr>
<tr class="payInfo">
<td class="grey1 tile6">Salary:</td>
<td class="grey1 tile7">$$this->salaryWage</td>
</tr>
<tr class="payInfo">
<td class="grey1 tile6">Hourly</td>
<td class="grey1 tile7">$$this->hourlyWages</td>
</tr>
$ahtml
$phtml
$sHtml
<tr class="payInfo">
<td class="grey1 tile6">OT Time and Half $this->otDateRange</td>
<td class="grey1 tile7">$$this->OT</td>
</tr>
<tr class="payInfo">
<td class="grey1 tile6">OT Double Time $this->otDateRange</td>
<td class="grey1 tile7">$$this->overtimeTier2</td>
</tr>
<tr class="payInfo">
<td class="grey1 tile6">Prorate Hours</td>
<td class="grey1 tile7">$this->baseProrateAmount</td>
</tr>
<tr class="payInfo">
<td class="grey1 tile6">Hours Projected</td>
<td class="grey1 tile7">$this->hoursProjected</td>
</tr>
<tr class="payInfo">
<td class="grey1 tile6">Total Hours</td>
<td class="grey1 tile7">$this->totalHours</td>
</tr>
<tr class="payInfo">
<td class="grey1 tile8">Subtotal</td>
<td class="grey1 tile9">$$this->subTotal</td>
</tr>
...
<tr>$this->salesHtml</tr>
<tr>$this->commissionReturnHtml</tr>
...
<tr>
<td colspan= "2" class="tabPad1">&nbsp;</td>
</tr>


<tr class="tabHead2">
<td colspan="2" class="oBtext tileS2">
Employee Deductions and Additions One
</td> 
</tr>
<tr>
<td class="black1 tile1 padTop">Select One</td>
<td class="black1 tile2 padTop"><input type="radio"  name="da1$this->recSalt"  class="sub" value="d" onClick="setTextColor(this, $this->recSalt, 'amount1'); switchAddSum('da1$this->recSalt', 'val', 'amount1$this->recSalt');" $this->radioCheckOneD />&nbsp;Deduction&nbsp;&nbsp;<input type="radio"  name="da1$this->recSalt" class="add" value="a" onClick="setTextColor(this, $this->recSalt, 'amount1'); switchAddSum('da1$this->recSalt', 'val', 'amount1$this->recSalt');" $this->radioCheckOneA />&nbsp;Addition</td>
</tr>
<tr>
<td class="black1 tile1">Amount</td>
<td class="black1 tile2">
<input  type="text" name="amount1$this->recSalt"  id="amount1$this->recSalt" class="val" value="$this->addSubAmountOne"  size="10" maxlength="10" onKeyUp ="return adjustTotal(this, 'da1$this->recSalt', 'val');" onClick="this.focus();this.select();"/></td>
</tr>
<tr>
<td class="black1 tile1">Description</td>
<td class="black1 tile2"><input  type="text" name="desc1$this->recSalt"  id="desc1$this->recSalt" class="desc" value="$this->addSubDescOne" size="30" maxlength="30"/></td>
</tr>
<tr>
<td class="black1 tile3">Recursive</td>
<td class="black1 tile4"><input type="checkbox" name="rec1$this->recSalt" class="recur" value="1" $this->recurseCheckOne />&nbsp;Make this deduction/addition each pay period</td>
</tr>

<tr>
<td colspan= "2" class="tabPad2 black1">&nbsp;</td>
</tr>

<tr class="tabHead2">
<td colspan="2" class="oBtext tileS2">
Employee Deductions and Additions Two
</td> 
</tr>
<tr>
<td class="black1 tile1 padTop">Select One</td>
<td class="black1 tile2 padTop"><input type="radio" name="da2$this->recSalt" class="sub" value="d" onClick="setTextColor(this, $this->recSalt, 'amount2'); switchAddSum('da2$this->recSalt', 'val', 'amount2$this->recSalt');" $this->radioCheckTwoD />&nbsp;Deduction&nbsp;&nbsp;<input type="radio" name="da2$this->recSalt" class="add" value="a" onClick="setTextColor(this, $this->recSalt, 'amount2'); switchAddSum('da2$this->recSalt', 'val', 'amount2$this->recSalt');" $this->radioCheckTwoA />&nbsp;Addition</td>
</tr>
<tr>
<td class="black1 tile1">Amount</td>
<td class="black1 tile2">
<input  type="text" name="amount2$this->recSalt"  id="amount2$this->recSalt" class="val" value="$this->addSubAmountTwo"  size="10" maxlength="10" onKeyUp ="return adjustTotal(this, 'da2$this->recSalt', 'val');" onClick="this.focus();this.select();"/></td>
</tr>
<tr>
<td class="black1 tile1">Description</td>
<td class="black1 tile2"><input  type="text" name="desc2$this->recSalt"  id="desc2$this->recSalt" class="desc" value="$this->addSubDescTwo" size="30" maxlength="30"/></td>
</tr>
<tr>
<td class="black1 tile3">Recursive</td>
<td class="black1 tile4"><input type="checkbox" name="rec2$this->recSalt" class="recur" value="1" $this->recurseCheckTwo />&nbsp;Make this deduction/addition each pay period</td>
</tr>
...
<tr class="tabHead2">
<td colspan="2" class="oBtext tileS2">
Employee Deductions and Additions Three
</td> 
</tr>
<tr>
<td class="black1 tile1 padTop">Select One</td>
<td class="black1 tile2 padTop"><input type="radio" name="da3$this->recSalt" class="sub" value="d" onClick="setTextColor(this, $this->recSalt, 'amount3'); switchAddSum('da3$this->recSalt', 'val', 'amount3$this->recSalt');" $this->radioCheckThreeD />&nbsp;Deduction&nbsp;&nbsp;<input type="radio" name="da3$this->recSalt" class="add" value="a" onClick="setTextColor(this, $this->recSalt, 'amount3'); switchAddSum('da3$this->recSalt', 'val', 'amount3$this->recSalt');" $this->radioCheckThreeA />&nbsp;Addition</td>
</tr>
<tr>
<td class="black1 tile1">Amount</td>
<td class="black1 tile2">
<input  type="text" name="amount3$this->recSalt"  id="amount3$this->recSalt" class="val" value="$this->addSubAmountThree" size="10" maxlength="10" onKeyUp ="return adjustTotal(this, 'da3$this->recSalt', 'val');" onClick="this.focus();this.select();"/></td>
</tr>
<tr>
<td class="black1 tile1">Description</td>
<td class="black1 tile2"><input  type="text" name="desc3$this->recSalt"  id="desc3$this->recSalt" class="desc" value="$this->addSubDescThree" size="30" maxlength="30"/></td>
</tr>
<tr>
<td class="black1 tile3">Recursive</td>
<td class="black1 tile4"><input type="checkbox" name="rec3$this->recSalt" class="recur" value="1" $this->recurseCheckThree />&nbsp;Make this deduction/addition each pay period</td>
</tr>
...
<tr class="tabHead2">
<td colspan="2" class="oBtext tileS2">
Employee Deductions and Additions Four
</td> 
</tr>
<tr>
<td class="black1 tile1 padTop">Select One</td>
<td class="black1 tile2 padTop"><input type="radio" name="da4$this->recSalt" class="sub" value="d" onClick="setTextColor(this, $this->recSalt, 'amount4'); switchAddSum('da4$this->recSalt', 'val', 'amount4$this->recSalt');" $this->radioCheckFourD />&nbsp;Deduction&nbsp;&nbsp;<input type="radio" name="da4$this->recSalt" class="add" value="a" onClick="setTextColor(this, $this->recSalt, 'amount4'); switchAddSum('da4$this->recSalt', 'val', 'amount4$this->recSalt');" $this->radioCheckFourA />&nbsp;Addition</td>
</tr>
<tr>
<td class="black1 tile1">Amount</td>
<td class="black1 tile2">
<input  type="text" name="amount4$this->recSalt"  id="amount4$this->recSalt" class="val" value="$this->addSubAmountFour" size="10" maxlength="10" onKeyUp ="return adjustTotal(this, 'da4$this->recSalt', 'val');" onClick="this.focus();this.select();"/></td>
</tr>
<tr>
<td class="black1 tile1">Description</td>
<td class="black1 tile2"><input  type="text" name="desc4$this->recSalt"  id="desc4$this->recSalt" class="desc" value="$this->addSubDescFour" size="30" maxlength="30"/></td>
</tr>
<tr>
<td class="black1 tile3">Recursive</td>
<td class="black1 tile4"><input type="checkbox" name="rec4$this->recSalt" class="recur" value="1" $this->recurseCheckFour />&nbsp;Make this deduction/addition each pay period</td>
</tr>
...
<th align=\"left\"  bgcolor=\"#303030\"><font face=\"Arial\" size=\"1\" color=\"#FFFFFF\">Hours Worked</font></th>
  ...
  // echo"<br><br>d1 $this->dateStart  d2 $this->dateEnd";
$dbMain = $this->dbconnect();
$stmt = $dbMain ->prepare("SELECT timeclock_key, clock_in, clock_out FROM timeclock WHERE  id_card='$this->idCard' AND (clock_out BETWEEN  '$this->dateStart' AND '$this->dateEnd') ORDER BY clock_in ASC");
             $stmt->execute();      
             $stmt->store_result();      
       ...
       if($rowCount != 0)  {
                    ...
                    while ($stmt->fetch()) { 
                        ...
                        $this->hoursList2 .= "$hoursDate,$diff,$in,$out|";
               ...
               //$RegTimeH =  date('G',mktime (0,0,$totalSeconds,0,0,0));
               $RegTimeM =  date('i',mktime (0,0,$totalSeconds,0,0,0));
               $RegTimeS =  date('s',mktime (0,0,$totalSeconds,0,0,0));
               $hours = floor($totalSeconds / 3600);
               
               //echo "$$$$$$  H $hours  M $RegTimeM  S $RegTimeS";
               /*$minutes = floor(($totalSeconds / 60) % 60);
               echo "totsecs $totalSeconds ttimeh $testTimeH ttimeM $testTimeM ttimes $testTimeS h $hours  m $minutes";
               if ($minutes < 10){
                $minutes = "0$minutes";
               }
               if ($minutes == '59'){
               ...
               $totalHours = "$hours.$RegTimeM.$RegTimeS";
           //   echo"######tothours  $totalHours";
                
              $totalHours = $totalHours - $this->weeklyOvertime - $this->overtimeTier2;//************debugothourstier2 is zeroed out
              if ($totalHours < 0){
                $totalHours = 0;
              }
            //    echo"######tothours2  $totalHours  weekot $this->weeklyOvertime  ottier2  $this->overtimeTier2";
       ...
       if($rowCount != 0)  {
                    ...
                    while ($stmt999->fetch()) {  
                            ...
                            if($name != ''){
                                ...
                                $this->htmlArray .= "$name,$contract_key,$service_type,$session_price,$formattedDate,$onClock|";
       ...
       if($rowCount2 != 0)  {
                    ...
                    while ($stmt999->fetch()) {  
                            ...
                            if($name != ''){
                                ...
                                $this->htmlArrayTA .= "$name,$contract_key,$service_type,$payAmount,$formattedDate,$onClock|";
...
$dbMain = $this->dbconnect();
$stmt = $dbMain ->prepare("SELECT comp_type, comp_amount, payment_cycle, hours_projected, id_card  FROM basic_compensation WHERE type_key = '$this->typeKey' AND user_id='$this->userId' ");
$stmt->execute();      
$stmt->store_result(); 
$stmt-> bind_result($comp_type, $comp_amount, $payment_cycle, $hours_projected, $id_card);
$stmt->fetch();  
...
switch ($this->compensationType) {
    ...
    $this->commissionTotal = 'NA';
    $this->subTotal = sprintf("%01.2f", $this->salaryWage + $this->ptTotal + $this->extraPerformanceMoney + $this->ptTotalTA - $this->commissionReturnTotal + $this->bonusPayout);
    ...
    $cents = ($array[1]/60) * ($this->compensationAmount * 1.5);                                                                                             $this->OT = sprintf("%01.2f", ($dollars + $cents));
    ...
    $this->salaryWage = 'NA';
    $this->commissionTotal = 'NA';
    $this->subTotal = sprintf("%01.2f", $this->hourlyWages + $this->OT + $this->overtimeTier2 + $this->ptTotal + $this->extraPerformanceMoney + $this->ptTotalTA - $this->commissionReturnTotal + $this->bonusPayout);
    ...
    $this->subTotal = sprintf("%01.2f", $this->commissionTotal + $this->ptTotal + $this->extraPerformanceMoney + $this->ptTotalTA - $this->commissionReturnTotal + $this->bonusPayout);
    ...
    break;
     ...
     $this->salaryWage = sprintf("%01.2f", $this->compensationAmount + $this->ptTotal + $this->extraPerformanceMoney + $this->ptTotalTA - $this->commissionReturnTotal + $this->bonusPayout);
     $this->basePay = $this->salaryWage;
     $this->loadCommissionTotal();
    ...
    $this->subTotal = sprintf("%01.2f", $this->salaryWage + $this->commissionTotal);
    }    
    break;  
    case "HC":
    $this->loadHours();
    ...
    $this->subTotal = sprintf("%01.2f", $this->hourlyWages + $this->commissionTotal + $this->OT + $this->overtimeTier2 + $this->ptTotal + $this->extraPerformanceMoney + $this->ptTotalTA - $this->commissionReturnTotal + $this->bonusPayout);
    }    
    break;    
    }
...
switch ($add_sub_one) {
    case "E":
    $this->radioCheckOneD = null;
    $this->radioCheckOneA = null;
    $this->recurseCheckOne = null;
    $this->addSubAmountOne = null;
    $this->addSubDescOne = null;
    break;
    case "A": 
    $this->radioCheckOneD = null;
    $this->radioCheckOneA = 'checked';
    $this->recurseCheckOne = 'checked';
...
switch ($add_sub_two) {
    case "E":
    $this->radioCheckTwoD = null;
    $this->radioCheckTwoA = null;
    $this->recurseCheckTwo = null;
    $this->addSubAmountTwo = null;
    $this->addSubDescTwo = null;
    break;
    case "A": 
    $this->radioCheckTwoD = null;
    $this->radioCheckTwoA = 'checked';
    $this->recurseCheckTwo = 'checked';
...
switch ($add_sub_three) {
    case "E":
    $this->radioCheckThreeD = null;
    $this->radioCheckThreeA = null;
    $this->recurseCheckThree = null;
    $this->addSubAmountThree = null;
    $this->addSubDescThree = null;
    break;
    case "A": 
    $this->radioCheckThreeD = null;
    $this->radioCheckThreeA = 'checked';
    $this->recurseCheckThree = 'checked';
...
switch ($add_sub_four) {
    case "E":
    $this->radioCheckFourD = null;
    $this->radioCheckFourA = null;
    $this->recurseCheckFour = null;
    $this->addSubAmountFour = null;
    $this->addSubDescFour = null;
    break;
    case "A": 
    $this->radioCheckFourD = null;
    $this->radioCheckFourA = 'checked';
    $this->recurseCheckFour = 'checked';
...
function getSalaryWage() {
           return($this->salaryWage);
           }
function getHourlyWages() {
          return($this->hourlyWages);
          }
function getOT(){
            return($this->OT);
}
function getOTDoubtime(){
            return($this->overtimeTier2);
}
function getHoursProjected() {
          return($this->hoursProjected);
          }
...
function getCompensationType() {
          return($this->compensationType);
          }
function getIdCard() {
          return($this->idCard);
          }
function getBaseProrateAmount(){
    return($this->baseProrateAmount);
    }    
function getClubId() {
    return($this->clubId);
    } 
...
function getHoursList2(){
    return($this->hoursList2);
    }
function getPtHtml(){
    return($this->htmlArray);
}             
function getPtHtmlTA(){
    return($this->htmlArrayTA);
} 
function getCommissionHtml(){
    return($this->comishHtmlArray);
} 
function getSalesHtml(){
    return($this->salesHtmlArray);
}   
