...
include "../templates/timeClockListTemplate.php";
exit;
}
...
$javaScript1 = "<script type=\"text/javascript\" src=\"../scripts/searchTimeClockEmployee.js\"></script>";
...
include "../templates/searchTimeClockTemplate.php";
