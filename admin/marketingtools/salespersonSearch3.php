...
include "salespersonList3.php";
$getLists = new timeClockLists();
...
include "../templates/salespersonListTemplate3.php";
exit;
}
...
$javaScript1 = "<script type=\"text/javascript\" src=\"../scripts/searchSalespersonEmployee3.js\"></script>";
...
include "../templates/searchSalespersonTemplate3.php";
