...
$stmt->bind_param('iiisssssssss', $barCode, $passId, $duration, $startDate, $endDate, $guestName, $guestPhone, $guestEmail, $interestOne, $interestTwo, $location_id, $this->price);    
if(!$stmt->execute())  {
	printf("Error: %s.\n", $stmt->error);
   }		
